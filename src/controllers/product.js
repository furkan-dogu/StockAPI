...
module.exports = {
    ...
    list: async (req, res) => {
        ...
        */
        ...
        res.status(200).send({
            error: false,
            details: await res.getModelListDetails(Product, {}, ["categoryId", "brandId"]),
            data
        })
    },
        ...
        /*
            ...
            #swagger.parameters['body'] = {
                ...
                schema: {
                    ...
                    brandId: "65343222b67e9681f937d542",
                    name: "Product 1",
                    price: 10,
                    quantity: 10
                }
    ...
    update: async (req, res) => {
        ...
        */
        ...
        res.status(202).send({
            error: false,
            data,
            new: await Product.findOne({ _id: req.params.id }).populate(["categoryId", "brandId"])
        })
    },
